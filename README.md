...
A página apresenta:
* **Branding:** Logotipos da Nintendo e Pokémon.
* **Galeria de Jogos:** Destaques visuais para títulos como:
...
1.  **Clone o repositório:**
    ```bash
    git clone [https://github.com/Gabrie1Tk/Atividade_5_11-04.git](https://github.com/Gabrie1Tk/Atividade_5_11-04.git)
    ```
2.  **Abra o projeto:**
